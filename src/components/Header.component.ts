...
@Component({
  ...
  template: `
    <header
      class="w-screen mx-auto flex justify-between items-center z-[999] px-4 py-4 fixed top-0 left-0 right-0 bg-gradient-to-b from-white via-white to-[#FFF9F3]/20"
    >
