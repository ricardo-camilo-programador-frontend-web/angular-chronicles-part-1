  ...
  template: `
    <main class="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8 space-y-8 pt-32">
      ...
      <section class="text-gray-700 dark:text-gray-300">
        ...
        <div class="space-y-6">
          <div>
            <h3 class="text-xl font-medium text-gray-900 dark:text-white mb-4">{{ 'privacyPolicy.whatAreCookies' | translate }}</h3>
            <p>
      ...
      <section class="text-gray-700 dark:text-gray-300 space-y-6">
        <h3 class="text-xl font-medium text-gray-900 dark:text-white">{{ 'privacyPolicy.cookiesWeSet' | translate }}</h3>
        <ul class="space-y-4 list-none pl-0">
          <li class="border-l-4 border-gray-200 dark:border-gray-700 pl-4">
            <span class="font-medium">{{ 'privacyPolicy.cookieAccount' | translate }}</span>
            <p class="mt-2">
              {{ 'privacyPolicy.cookieAccountP' | translate }}
            </p>
          </li>
          <li class="border-l-4 border-gray-200 dark:border-gray-700 pl-4">
            <span class="font-medium">{{ 'privacyPolicy.cookieLogin' | translate }}</span>
            <p class="mt-2">
              {{ 'privacyPolicy.cookieLoginP' | translate }}
            </p>
          </li>
          <li class="border-l-4 border-gray-200 dark:border-gray-700 pl-4">
            <span class="font-medium">{{ 'privacyPolicy.cookieNewsletter' | translate }}</span>
            <p class="mt-2">
              {{ 'privacyPolicy.cookieNewsletterP' | translate }}
            </p>
          </li>
          <li class="border-l-4 border-gray-200 dark:border-gray-700 pl-4">
            <span class="font-medium">{{ 'privacyPolicy.cookieShopping' | translate }}</span>
            <p class="mt-2">
              {{ 'privacyPolicy.cookieShoppingP' | translate }}
            </p>
          </li>
          <li class="border-l-4 border-gray-200 dark:border-gray-700 pl-4">
            <span class="font-medium">{{ 'privacyPolicy.cookieSearch' | translate }}</span>
            <p class="mt-2">
              {{ 'privacyPolicy.cookieSearchP' | translate }}
            </p>
          </li>
          <li class="border-l-4 border-gray-200 dark:border-gray-700 pl-4">
            <span class="font-medium">{{ 'privacyPolicy.cookieForms' | translate }}</span>
            <p class="mt-2">
              {{ 'privacyPolicy.cookieFormsP' | translate }}
            </p>
          </li>
          <li class="border-l-4 border-gray-200 dark:border-gray-700 pl-4">
            <span class="font-medium">{{ 'privacyPolicy.cookiePreferences' | translate }}</span>
            <p class="mt-2">
      ...
      <section class="text-gray-700 dark:text-gray-300 space-y-6">
        <h3 class="text-xl font-medium text-gray-900 dark:text-white">{{ 'privacyPolicy.thirdPartyCookies' | translate }}</h3>
        <div class="prose dark:prose-invert max-w-none">
          <p>
          ...
          <ul>
            <li>
              ...
              <a href="https://analytics.google.com/analytics/web/"
                >{{ 'privacyPolicy.googleAnalytics' | translate }}</a
      ...
      <section class="text-gray-700 dark:text-gray-300 space-y-6">
        <h3 class="text-xl font-medium text-gray-900 dark:text-white">{{ 'privacyPolicy.userCommitment' | translate }}</h3>
        <p>
      ...
      <section class="text-gray-700 dark:text-gray-300 space-y-6">
        <h3 class="text-xl font-medium text-gray-900 dark:text-white">{{ 'privacyPolicy.blockCookies' | translate }}</h3>
        <p>
      ...
      <section class="text-gray-700 dark:text-gray-300 space-y-4">
        <h3 class="text-xl font-medium text-gray-900 dark:text-white">{{ 'privacyPolicy.moreInfo' | translate }}</h3>
        <div class="prose dark:prose-invert max-w-none">
          <p>
        ...
        <p class="text-sm mt-8">
          ...
          <strong>{{ 'privacyPolicy.month' | translate }}</strong>/<strong>{{ 'privacyPolicy.year' | translate }}</strong>.
        </p>
      </section>
    </main>
  `,
